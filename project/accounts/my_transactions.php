...
<div class="filter">
    ...
    <lable for="type_filter"> Action Type: </label> 
        <select class="type_filter" name="action" value="<?php echo $result["action"]; ?>" >
                ...
                <option value ="withdrawl" <?php echo($result["action"] == "withdrawl" ? 'selected="selected"' : ''); ?>>withdrawl</option>
