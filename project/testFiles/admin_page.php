...
<h3 class="text-center"><strong>Search for Account</strong></h3> 
  ...
  <?php foreach($results as $r):?>
    <div align="center" class="card-text">
      ...
      <a type="button" class="btn btn-primary" name="search" href="<?php echo getURL("/project/accounts/my_transactions.php?id=" . $r["accID"] . "&viewer=" . $id)?>">Go To <?php echo ($r["firstName"] . " " .$r["lastName"]) ?>  Transactions History</a>
    </div>
  <?php endforeach;?>
<hr>  
